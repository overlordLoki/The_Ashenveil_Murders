...
namespace The_Ashenveil_Murders.Core.Localization;
...
internal class LocalizationManager
{
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        ResourceManager resourceManager = new ResourceManager("The_Ashenveil_Murders.Core.Localization.Resources", assembly);
