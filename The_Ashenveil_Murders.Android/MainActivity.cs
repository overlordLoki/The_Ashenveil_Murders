...
using The_Ashenveil_Murders.Core;

namespace The_Ashenveil_Murders.Android
{
    /// <summary>
    ...
    {
        private The_Ashenveil_MurdersGame _game;
        private View _view;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _game = new The_Ashenveil_MurdersGame();
